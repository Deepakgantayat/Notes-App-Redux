        ...
        <React.Fragment>
            ...
            <Row>
            {
                        this.props.notes.map((note, index) => {
                            return (
                                <Col md="3" key={index}>
                                    <Card body inverse style={{ backgroundColor: '#155', borderColor: '#333' }} className="mb-4">
                                        ...
                                        <Container className="mt-3">
                                             <Row>
                                                 <Col md="6">
                                                     <Link to={`/notes/${note._id}`}><Button color="dark">edit</Button></Link>
                                                 </Col>
                                                 <Col md="6">
            ...
            <div className='container'>
            <Link to="/notes/new" ><Button color="success" >Add Note</Button></Link>
            </div>
        </React.Fragment>
        )
    }
